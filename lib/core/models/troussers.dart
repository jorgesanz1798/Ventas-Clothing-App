/* Esta página muestra todos los pantalones que se encuentran en la base de datos. */
...
class _TroussersState extends State<Troussers> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      /* Aqui se obtienen los pantalones. */
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        /* En caso de que no existan pantalones mostrará una pantalla de mantenimiento */
        ...
        /* Si existen pantalones aqui los muestra */
        return Padding(
